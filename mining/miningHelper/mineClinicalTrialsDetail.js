...
const run = async (clinicalTrials) => {
  // // collect all clinicial trial ids from projects and publications
  // let clinicalTrialIDs = [];
  // for (var proj in projects) {  // projects have clinical trials
  //   if (proj.clinicalTrials) {
  //     clinicalTrialIDs.concat(proj.clinicalTrials);
  //   }
  // }
  // for (var pub in publications) {  // publications have clinical trials
  //   if (pub.clinicalTrials) {
  //     clinicalTrialIDs.concat(pub.clinicalTrials);
  //   }
  // }
  ...
  // for (let k = 0; k < clinicalTrialIDs.length; k++) {
  let counter = 0;
  for (var clinicaltrialID in clinicalTrials) {
    // let clinicaltrialID = clinicalTrialIDs[k];
